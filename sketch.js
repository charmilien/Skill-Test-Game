...
function draw(){ 
 console.log(mouseX,mouseY);
  ...
  if(gameState==="Start"){
    ...
    text("but it is not so easy.You have to clear the test set by the king wich is hit the target 3 times and don't touch the waterballs .",310,350);
...
function aiming(){
  ...
  button.hide();
    ...
    if(score===3&&score2===4&&bullscore===1){
      ...
      fill("blue");
      textFont("Italic")
      text("Your Aiming  skill is not perfect try hard to win all the levels",300,500)
    }
    ...
    if(Win===3){
      textSize(60);
      fill("blue");
      text("Your Aiming skill:3/3 😁",550,500)
